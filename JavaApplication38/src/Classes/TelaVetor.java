...
public class TelaVetor extends javax.swing.JFrame {
    ...
    public TelaVetor() {
        initComponents();
        for(int c = 0; c < vetor.length; c++) {//enquanto contador for menor que tamando do vetor, conte mais 1
            lista.addElement(vetor[c]);//adicionando contador
        }
    }          
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        lista.removeAllElements();//zerando lista
        for(int c = 0; c < vetor.length; c++) {//enquanto contador for menor que tamando do vetor, conte mais 1
            lista.addElement(vetor[c]);//adicionando contador
        }
